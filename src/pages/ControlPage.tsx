...
className="bg-[#1C1C1E] border border-[rgba(1,214,190,0.2)] rounded-[28px] p-5 mb-4 relative overflow-hidden"
>
{/* 三列功率显示 */}
...
{port.type === 'ac-out' ? '220V / 50Hz · Max 2000W' : '5V/9V/12V · Max 100W'}
 ...
 {/* 已填充部分 */}
 <div
 className="absolute left-0 h-2 rounded-full bg-[#34C759]
 (52,199,89,0.3)] pointer-events-none"
 style={{ width: `${(settings.chargeLimit - 50) / 50 * 100}%` }}
 />
 {/* 拇指指示点：用 calc 避免边界溢出 */}
 <div
 className="absolute w-5 h-5 rounded-full bg-white border-2 border-[#34C759]
 (52,199,89,0.4),0_2px_6px_rgba(0,0,0,0.3)]
 pointer-events-none"
 style={{
