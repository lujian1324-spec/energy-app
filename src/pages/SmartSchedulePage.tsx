      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide px-5 pb-4">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <div className="text-[11px] font-bold text-[#8E8E93] tracking-widest uppercase">Electricity Rate</div>
            {peakShavingSettings.touRateInfo && (
              <span className="text-[11px] px-2 py-0.5 rounded-full bg-[rgba(1,214,190,0.12)] text-[#01D6BE] font-medium">
                {peakShavingSettings.touRateInfo.provider}
              </span>
            )}
          </div>
          ...
          {peakShavingSettings.touRateInfo ? (
            <div>
              <div className="space-y-2 mb-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-[#FF9500]" />
                    <span className="text-[13px] text-[#FFFFFF]">Peak</span>
                  </div>
                  <span className="text-[13px] text-[#FF9500] font-semibold">
                    ${peakShavingSettings.peakPrice}/kWh
                    <span className="text-[11px] text-[#8E8E93] font-normal ml-1">
                      ({peakShavingSettings.touRateInfo.peakHours.start}–{peakShavingSettings.touRateInfo.peakHours.end})
                    </span>
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-[#34C759]" />
                    <span className="text-[13px] text-[#FFFFFF]">Off-Peak</span>
                  </div>
                  <span className="text-[13px] text-[#34C759] font-semibold">
                    ${peakShavingSettings.offPeakPrice}/kWh
                    <span className="text-[11px] text-[#8E8E93] font-normal ml-1">
                      ({peakShavingSettings.touRateInfo.offPeakHours.start}–{peakShavingSettings.touRateInfo.offPeakHours.end})
                    </span>
                  </span>
                </div>
                {peakShavingSettings.partPeakPrice && peakShavingSettings.touRateInfo.partPeakHours && (
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-[#FFD700]" />
                      <span className="text-[13px] text-[#FFFFFF]">Part-Peak</span>
                    </div>
                    <span className="text-[13px] text-[#FFD700] font-semibold">
                      ${peakShavingSettings.partPeakPrice}/kWh
                      <span className="text-[11px] text-[#8E8E93] font-normal ml-1">
                        ({peakShavingSettings.touRateInfo.partPeakHours!.start}–{peakShavingSettings.touRateInfo.partPeakHours!.end})
                      </span>
                    </span>
                  </div>
                )}
              ...
              <button
                onClick={() => { setShowTouLookup(true); setZipInput(peakShavingSettings.zipCode || '') }}
                className="text-[11px] text-[#01D6BE] underline"
              >
                Change ZIP Code
              </button>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[12px] text-[#8E8E93]">Enter ZIP code to auto-detect local rates</span>
              </div>
              ...
              {touNotFound && (
                <p className="text-[11px] text-[#FF9500] mt-2">ZIP code not found in database. You can enter custom rates in Settings.</p>
              )}
              <button
                onClick={() => setShowSettings(true)}
                className="text-[11px] text-[#8E8E93] underline mt-2 block"
              >
                Enter custom rates manually
              </button>
            </div>
          )}
        </motion.div>
