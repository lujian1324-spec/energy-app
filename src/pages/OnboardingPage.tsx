 ...
 * the name the app shows and the nickname on the account.
 */
...
export default function OnboardingPage() {
   ...
   * what Settings and Profile read and it cannot fail. The account nickname is
  ...
  const saveName = async () => {
    ...
    try {
      const r = await updateUserInfo({ nickname: trimmed })
