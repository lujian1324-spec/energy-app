...
> 2026-09-23 更新：以下 v4.0.0 快照仅供历史参考，不能作为当前发布状态。
> 4.14.4 集成状态与验收项目见 [RELEASE_4.14.4.md](RELEASE_4.14.4.md)。
> Android production 上传与 iOS 签名/TestFlight 管线已在 4.14.2 成功执行；实际分发和真机验收另行核实。
