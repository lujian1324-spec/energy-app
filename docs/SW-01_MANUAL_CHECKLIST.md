...
- Fail twice consecutively: confirm a scrollable troubleshooting panel offers power cycling, pairing LED mode, Bluetooth / Nearby devices permission, Location on older Android, and moving closer. Verify Search Again works. Since SW-10 the panel ends there: no QR step and no Scan QR Code button.
